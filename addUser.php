		...
		<div class="table-wrapper">
			...
			while ($result = mysqli_fetch_assoc($mysqliquery)) {
				...
				<tr>
					...
					<td>
				    <a href="#editEmployeeModal" class="edit" data-toggle="modal" data-id="<?php echo $result['id']; ?>"><i class="material-icons" data-toggle="tooltip" title="Update">&#xE254;</i></a>
